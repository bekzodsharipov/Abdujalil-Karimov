...
document.addEventListener("DOMContentLoaded", function () {
  const items = document.querySelectorAll(".accardion__info");

  items.forEach((item) => {
    const header = item.querySelector(".accardion__info__top");
    const content = item.querySelector(".accardion__text");
    ...
    header.addEventListener("click", () => {
      ...
      if (isOpen) {
        ...
        items.forEach((other) => {
          const otherContent = other.querySelector(".accardion__text");
